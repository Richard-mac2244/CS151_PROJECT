...
public class BoardBW extends JFrame implements Board {
	...
	public JButton makeButton(int rowIndex, int colIndex) {
		...
		button.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) { // TODO make a button unclickable once it is set to something
															// other than 3
				System.out.println("Row Index: " + rowIndex + " Column Index: " + colIndex + " Turn number: "
						+ BoardModel.turnNumber + ", Value being passed: " + (BoardModel.turnNumber % 2));
	...
	// change icon display based on model data and winner conditions
			...
			public void actionPerformed(ActionEvent e) {
				...
				if (BoardModel.turnNumber % 2 == 0) { // the current player is X, meaning the last one to remove is O
					if (BoardModel.oUndo < 3) { // check how many times X has clicked undo in total
						...
						System.out.println("Row Index Removed: " + currRow + " Column Index Renoved: " + currCol
								+ " Turn number: " + BoardModel.turnNumber + ", Value being passed: " + 100);
